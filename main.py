...
app_id = int(os.environ.get("app_id", "20601073"))
api_hash = os.environ.get("api_hash", "a99848cf240773df26d3efad8195c194")
bot_token = os.environ.get("bot_token", "8286695357:AAG-u8G6B0u8sPFhveQ1AmlWMi_PNht1zpY")
...
<b>• Updates : <a href=t.me/MovieHuntZone>Click Here</a></b>
...
def start_buttons(bot, update):
    bot = bot.get_me()
    buttons = [[
        pyrogram.types.InlineKeyboardButton("Updates", url="t.me/MovieHuntZone"),
        pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
    ],[
        pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/{AUTOCAPTION40BOT}?startchannel=true")
    ]]
...
print("Bot Created By @MovieHuntZone")
